                ...
                <SignIn
                  appearance={{
                    elements: {
                      ...
                      formFieldInput:
                        "border border-border bg-background text-foreground font-mono text-xs focus:border-success",
                      formButtonPrimary:
                        "bg-success hover:bg-success/90 text-background font-mono text-xs font-bold",
                      footerActionLink: "text-buy hover:text-buy/80 font-mono",
